  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute -top-40 -left-24 size-[520px] rounded-full bg-[radial-gradient(circle,rgba(20,86,232,0.05),transparent_68%)]" />
      ...
      <motion.div
        ...
        className="pointer-events-none absolute right-0 bottom-0 hidden h-full aspect-[774/912] max-w-[44%] lg:block xl:max-w-[50%] 2xl:max-w-[52%]"
      >
        <Image
      ...
      <div className="shell relative z-10">
        <div className="flex flex-col justify-center py-10 sm:py-14 lg:min-h-[620px] lg:py-16 xl:min-h-[760px] 2xl:min-h-[860px]">
          <div className="w-full lg:max-w-[510px] xl:max-w-[580px] 2xl:max-w-[680px]">
            {/* ---- Eyebrow ---- */}
            <motion.p
              variants={fadeUp}
              initial="hidden"
            ...
            <motion.h1
              ...
              animate="show"
              custom={0.08}
              className="mt-5 text-[36px] leading-[1] font-extrabold tracking-[-0.042em] text-navy min-[380px]:text-[44px] sm:mt-6 sm:text-[58px] md:text-[68px] lg:text-[54px] xl:text-[68px] 2xl:text-[80px]"
            >
              {hero.titleLine1}
              <br />
            ...
            <motion.p
              ...
              animate="show"
              custom={0.16}
              className="mt-6 max-w-[600px] text-[16px] leading-[1.6] text-muted sm:mt-7 sm:text-[17.5px] 2xl:text-[19px]"
            >
              {hero.paragraph}
            </motion.p>
            ...
            <motion.div
              ...
              animate="show"
              custom={0.32}
              className="mt-7 flex flex-col gap-3.5 sm:mt-8 sm:flex-row sm:flex-wrap sm:gap-4"
            >
              <a
                href="#contact"
            ...
            <motion.dl
              ...
              animate="show"
              custom={0.4}
              className="mt-9 grid grid-cols-2 gap-x-6 gap-y-7 sm:mt-11 sm:grid-cols-4 sm:gap-x-0 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-6 xl:grid-cols-4 xl:gap-x-0"
            >
              {heroStats.map((stat, i) => (
                <div
                  ...
                  className={
                    i === 0
                      ? "sm:pr-5 lg:pr-0 xl:pr-7"
                      : "sm:border-l sm:border-hairline sm:pl-5 lg:border-l-0 lg:pl-0 xl:border-l xl:pl-7"
                  }
                >
            ...
            <motion.a
              ...
              animate="show"
              custom={0.5}
              className="group mt-12 hidden items-center gap-5 xl:inline-flex"
            >
              <span
                aria-hidden="true"
